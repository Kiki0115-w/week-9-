...
namespace Solution
{
    ...
    public class OOPPlayer : Character
    {
        ...
        public override void SetUP()
        {
            ...
            Vector2 StarPos = new Vector2(positionY, positionX);
            actionHistoryManager.SaveStateForUndo(StarPos);
        ...
        public override void Move(Vector2 direction)
        {
            ...
            Vector2 newPosirion = new Vector2(positionX, positionY);
            actionHistoryManager.SaveStateForUndo(newPosirion);
